<?php
	...
	$ACCESS_PWD='cock'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

	include('../sql.php');
	#DEFAULT db connection settings
	# --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
	$DBDEF=array('user'=>$mysql_user_write,#required
		'pwd'=>$mysql_password_write,#required
		'db'=>$mysql_database,#optional, default DB
		'host'=>$mysql_host,#optional
		'port'=>"",#optional
	...
	function display_select($sth,$q){
		...
		if($is_sht || $is_shd){
			...
			$sqldr.="<div class='dot'>
				...
				&nbsp;&#183;<a href='$url&q=show+processlist'>Show Processlist</a><br>";
			if($is_sht){
	...
	<head>
		...
		<script type="text/javascript">
			...
			function chkall(cab){
				...
				if(e!=null){
					var cl=e.length;
					for(i=0;i<cl;i++){ //TODO change to var i?
						var m=e[i];
